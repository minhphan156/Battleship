...
public class PlayerScreen extends JFrame {
    private int size;
    private boolean isbeginningOfTheGameOfPlayer1 = true;
    private boolean isbeginningOfTheGameOfPlayer2 = true;
    private BattleShip battleShip;
    private JLabel ownShipSunk;
    private JLabel shipBeginning;
    private JLabel enemyShipSunk;

    public JLabel getEnemyShipSunk(){
        return enemyShipSunk;
    }

    public JLabel getOwnShipSunk() {
        return ownShipSunk;
    }
    ...
    //return attackGrid of the player
