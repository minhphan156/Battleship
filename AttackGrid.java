                    ...
                    if (name.equals("Player1")) {
                        ...
                        if(!battleShip.getTakeTurnAttack()) {
                            ...
                            if (isSunk) {
                                ...
                                battleShip.getPlayer1().getEnemyShipSunk().setText(Integer.toString(enemyShipSunkPlayer1));
                                ...
                                battleShip.getPlayer2().getOwnShipSunk().setText(ownShipSunkPlayer2);
                            }
                        }
                    ...
                    if (name.equals("Player2")) {
                        if(battleShip.getTakeTurnAttack()) {
                            ...
                            if (isSunk) {
                                ...
                                battleShip.getPlayer2().getEnemyShipSunk().setText(Integer.toString(enemyShipSunkPlayer2));
                                ...
                                battleShip.getPlayer1().getOwnShipSunk().setText(ownShipSunkPlayer1);
                            }
                        }
